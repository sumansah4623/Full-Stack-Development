...
function AddBook({ initialData }) {
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.Pages.trim()) newErrors.Pages = "Pages is required";
    if (!formData.PublishedYear.trim()) newErrors.PublishedYear = "Published year is required";
    ...
    const updatedBooks = initialData
    ? existingBooks.map((b) =>
        b.id === initialData.id ? bookData : b
      )
